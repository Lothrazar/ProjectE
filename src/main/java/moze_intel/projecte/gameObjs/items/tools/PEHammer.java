...
public class PEHammer extends PETool {
  ...
  /**
   * Simple copy of {@link net.minecraft.item.PickaxeItem#canHarvestBlock(BlockState)}'s fallback/shortcut to allow the hammer to also mine all blocks of that material.
   *
